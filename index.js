...
//                 Pong.__resetTurn.call(this, this.ai, this.player);
//             if (this.ball.y <= 0)
...
//             else if (this.ball.moveY === DIRECTION.RIGHT)
//                 this.ball.y += this.ball.speed;
...
//             if (this.ball.x - this.ball.widht <= this.player.x && this.ball.x >= this.player.x - this.player.width) {
...
//             if (this.ball.x - this.ball.widht <= this.ai.x && this.ball.x >= this.ai.x - this.ai.width)
//             {
...
//         if (Pong._turnDelayIsOver(this)) {
//             this.context.fillRect(this.ball.x, this.ball.y, this.ball.width, this.ball.height);
//         }

//         this.context.beginPath();
//         this.context.setLineDash([7, 15]);
//         this.context.moveTo(this.canvas.widht / 2, this.canvas.height - 140);
//         this.context.lineTo(this.canvas.widht / 2, 140);
...
//     _generateRoundColor: function(round) { 
